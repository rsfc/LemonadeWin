...
namespace Lemonade.Samples.LayoutSplitC
{
    /// <summary>
    /// 框架布局分栏B
    /// </summary>
    public class LayoutSplitC :ILayout
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public LayoutSplitCConfig UIConfig
        {
            get;
            set;
        }
        ...
        { 
            ...
            spc1.Name = "LayoutSplitCSplitContainer1";
            ...
            spc2.Orientation = Orientation.Vertical;
        ...
        protected void SetPanel(Form TargetForm)
        {
            ...
            foreach (SplitRegion sr in formlist.Keys)
            {
                ...
                if (tmpIndex == 1 || tmpIndex == 3 || tmpIndex == 2)
                {
        ...
        {
            SetSplitterDis(this.splitconts[2], this.UIConfig.LayoutRegion[0].Width);
            SetSplitterDis(this.splitconts[1], this.UIConfig.LayoutRegion[0].Width + this.UIConfig.LayoutRegion[1].Width);
            SetSplitterDis(this.splitconts[3], this.UIConfig.LayoutRegion[2].Height);
        }
