...
{
    public partial class FrmAction1 : Form,IModule
    {
        public FrmAction1()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Lemon.ActionAppend(tb, "TextChanged", ActionType.Single, new EventHandler(this.EventHandler), new ActionPerformer(RemoveActionAfter));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender"></param>
        protected void RemoveActionAfter(object sender)
        { 
